...
public class DataHolder {
    ...
    private Map<String, EndpointsRegistryImpl> endpointsRegistries = new HashMap<>();
    ...
    public Map<String, EndpointsRegistryImpl> getEndpointsRegistries() {
        return endpointsRegistries;
    }
